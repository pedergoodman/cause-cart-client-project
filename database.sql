...
VALUES 
('PawsAndClaws@meowmail.com', 'password1', 0),
('FluffyBunny@hoppylife.net', 'password2', 0),
('QuirkyQuokka@australiamail.com', 'password3', 0),
('SillySloth@slowmail.com', 'password4', 0),
('HappyHippo@watermail.com', 'password5', 0),
('DaringDuck@quackmeup.net', 'password6', 0),
('WigglyWorm@earthymail.com', 'password7', 0),
('JazzyJellyfish@oceanmail.com', 'password8', 0),
('FunkyFrog@ribbitmail.com', 'password9', 0),
('CheekyCheeta@fastmail.com', 'password10', 0);
